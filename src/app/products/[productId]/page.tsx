    ...
    return <div className="py-8 pb-8 px-12 divide-y divide-zinc-100 bg-white shadow-md rounded-b-md">
        <div>
            ...
            <div className="aspect-square my-6 border-border w-52 h-52">
                <div className="relative bg-zinc-100 w-full h-full overflow-hidden rounded-xl">
                        <Image src={`/${product.imageId}`} alt="product image "  fill loading="eager" className="h-full w-full object-cover object-center " />
                </div>
            </div>
            <div className="mt-4">
        ...
        <div className="mt-6 ">
            ...
            <div className="mt-6 text-center">
                <div className="iniline-flex text-sm text-medium">
